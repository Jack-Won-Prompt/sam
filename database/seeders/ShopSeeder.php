...
class ShopSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Banner::truncate();
        $banners = [
            ['title' => '강원도 청정 산양삼', 'subtitle' => '해발 700m 자연 그대로, 산이 키운 진짜 삼', 'position' => 'main_slider', 'bg_color' => '#1f5fd0', 'image' => 'banners/b1.jpg', 'link' => '/category/sanyangsam', 'sort_order' => 0],
            ['title' => '명절 선물, 정성을 담다', 'subtitle' => '프리미엄 산양삼 선물세트 최대 20% 할인', 'position' => 'main_slider', 'bg_color' => '#1c4fab', 'image' => 'banners/b2.jpg', 'link' => '/category/gift', 'sort_order' => 1],
            ['title' => '하루 한 포의 건강', 'subtitle' => '간편하게 즐기는 산양삼 진액즙', 'position' => 'main_slider', 'bg_color' => '#2570e6', 'image' => 'banners/b3.jpg', 'link' => '/category/processed', 'sort_order' => 2],
        ];
